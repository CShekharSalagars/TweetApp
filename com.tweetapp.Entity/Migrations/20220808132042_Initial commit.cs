            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TweetId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TweetMessage = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TweetDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TweetModifyDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TweetBy = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
